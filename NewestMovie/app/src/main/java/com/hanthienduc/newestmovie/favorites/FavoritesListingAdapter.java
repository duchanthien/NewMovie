...
public class FavoritesListingAdapter extends RecyclerView.Adapter<FavoritesListingAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            FavoritesListingAdapter.this.view.onMovieClicked(tvShowModel);
        }
    }

    FavoritesListingAdapter(List<Movie> tvShowModels, FavoritesView view) {
        this.tvShowModels = tvShowModels;
        this.view = view;
    }

    @Override
    public FavoritesListingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(FavoritesListingAdapter.ViewHolder holder, int position) {
